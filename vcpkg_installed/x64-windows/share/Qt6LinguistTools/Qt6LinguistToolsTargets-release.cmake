...
set_target_properties(Qt6::lconvert PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/lconvert.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lconvert )
list(APPEND _cmake_import_check_files_for_Qt6::lconvert "${_IMPORT_PREFIX}/tools/Qt6/bin/lconvert.exe" )
...
set_target_properties(Qt6::lprodump PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/lprodump.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lprodump )
list(APPEND _cmake_import_check_files_for_Qt6::lprodump "${_IMPORT_PREFIX}/tools/Qt6/bin/lprodump.exe" )
...
set_target_properties(Qt6::lrelease PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/lrelease.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lrelease )
list(APPEND _cmake_import_check_files_for_Qt6::lrelease "${_IMPORT_PREFIX}/tools/Qt6/bin/lrelease.exe" )
...
set_target_properties(Qt6::lrelease-pro PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/lrelease-pro.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lrelease-pro )
list(APPEND _cmake_import_check_files_for_Qt6::lrelease-pro "${_IMPORT_PREFIX}/tools/Qt6/bin/lrelease-pro.exe" )
...
set_target_properties(Qt6::lupdate PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/lupdate.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lupdate )
list(APPEND _cmake_import_check_files_for_Qt6::lupdate "${_IMPORT_PREFIX}/tools/Qt6/bin/lupdate.exe" )
...
set_target_properties(Qt6::lupdate-pro PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/lupdate-pro.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lupdate-pro )
list(APPEND _cmake_import_check_files_for_Qt6::lupdate-pro "${_IMPORT_PREFIX}/tools/Qt6/bin/lupdate-pro.exe" )
