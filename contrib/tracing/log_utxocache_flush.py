...
"""Example logging FlashCoin utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/FlashCoind
...
def main(pid):
    ...
    # to the tracepoints
    FlashCoind_with_usdts.enable_probe(
        probe="flush", fn_name="trace_flush")
    b = BPF(text=program, usdt_contexts=[FlashCoind_with_usdts])
