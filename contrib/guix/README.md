# Bootstrappable FlashCoin Builds

This directory contains the files necessary to perform bootstrappable FlashCoin
Core builds.
...
To build FlashCoin reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/FlashCoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/FlashCoin-core/guix.sigs).
