...
(define* (make-FlashCoin-cross-toolchain target
                                       #:key
...
desirable for building FlashCoin release binaries."
...
;; failure; see https://github.com/FlashCoin/FlashCoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-FlashCoin-cross-toolchain target)))
