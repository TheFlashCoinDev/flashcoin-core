...
complete --command FlashCoind --no-files

# Extract options
function __fish_FlashCoind_get_options
...
complete \
    --command FlashCoind \
    --arguments "(__fish_FlashCoind_get_options --nofiles)"
