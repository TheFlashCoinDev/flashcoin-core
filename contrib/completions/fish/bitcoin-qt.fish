...
complete --command FlashCoin-qt --no-files

# Extract options
function __fish_FlashCoinqt_get_options
...
complete \
    --command FlashCoin-qt \
    --arguments "(__fish_FlashCoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c FlashCoin-qt \
...
complete \
    --command FlashCoin-qt \
    --arguments "(__fish_FlashCoinqt_get_options --nofiles)"
