...
# Extract options
function __fish_FlashCoin_tx_get_options
...
# Extract commands
function __fish_FlashCoin_tx_get_commands
...
# Add options
complete \
    --command FlashCoin-tx \
    --condition "not __fish_FlashCoin_seen_cmd (__fish_FlashCoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_FlashCoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command FlashCoin-tx \
    --arguments "(__fish_FlashCoin_tx_get_commands)" \
    --no-files
