...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FlashCoin_CHAINPARAMSSEEDS_H\n')
    g.write('#define FlashCoin_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the FlashCoin network\n')
    ...
    g.write('#endif // FlashCoin_CHAINPARAMSSEEDS_H\n')
