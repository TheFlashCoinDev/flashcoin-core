...
FlashCoin. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring FlashCoin

**When configuring FlashCoin, CMake by default will ignore the depends output.** In
...
created. To use it during configuring FlashCoin:
...
variables will be set when generating the FlashCoin buildsystem. In this case, `-DENABLE_WALLET=OFF`.
