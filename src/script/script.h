...
#ifndef FlashCoin_SCRIPT_SCRIPT_H
#define FlashCoin_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, FlashCoin always counted CHECKMULTISIGs
...
#endif // FlashCoin_SCRIPT_SCRIPT_H
