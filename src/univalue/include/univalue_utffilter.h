...
#ifndef FlashCoin_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define FlashCoin_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // FlashCoin_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
