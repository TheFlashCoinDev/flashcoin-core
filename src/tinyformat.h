...
#include <algorithm>
#include <attributes.h> // Added for FlashCoin
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for FlashCoin
#include <util/string.h> // Added for FlashCoin
...
// Added for FlashCoin. Similar to std::runtime_format from C++26.
...
// Added for FlashCoin. Wrapper for checking format strings at compile time.
