...
#ifndef FlashCoin_ARITH_UINT256_H
#define FlashCoin_ARITH_UINT256_H
...
public:
     ...
     *
     * FlashCoin only uses this "compact" format for encoding difficulty
...
#endif // FlashCoin_ARITH_UINT256_H
