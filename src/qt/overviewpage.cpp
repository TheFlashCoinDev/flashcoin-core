...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = FlashCoinUnits::formatWithUnit(unit, amount, true, FlashCoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    FlashCoinUnit unit{FlashCoinUnit::BTC};
...
{
    FlashCoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(FlashCoinUnits::formatWithPrivacy(unit, balances.balance, FlashCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(FlashCoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, FlashCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(FlashCoinUnits::formatWithPrivacy(unit, balances.immature_balance, FlashCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(FlashCoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, FlashCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
