...
#ifndef FlashCoin_QT_OPTIONSMODEL_H
#define FlashCoin_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for FlashCoin client.
...
public:
    ...
    FlashCoinUnit getDisplayUnit() const { return m_display_FlashCoin_unit; }
...
private:
    ...
    QString language;
    FlashCoinUnit m_display_FlashCoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(FlashCoinUnit unit);
...
#endif // FlashCoin_QT_OPTIONSMODEL_H
