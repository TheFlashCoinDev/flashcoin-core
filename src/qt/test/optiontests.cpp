...
{
    // Test regression https://github.com/FlashCoin/FlashCoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/FlashCoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/FlashCoin-core/gui/pull/568.
    // With fListen=false in ~/.config/FlashCoin/FlashCoin-Qt.conf and all else left as default,
    // FlashCoin-qt should set both -listen and -listenonion to false and start successfully.
