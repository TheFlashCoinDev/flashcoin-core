...
//! Entry point for FlashCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &FlashCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for FlashCoinGUI tests.
void AppTests::guiTests(FlashCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &FlashCoinGUI::consoleShown, this, &AppTests::consoleTests);
