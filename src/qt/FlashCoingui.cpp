...
#include <qt/FlashCoingui.h>

#include <qt/FlashCoinunits.h>
...
const std::string FlashCoinGUI::DEFAULT_UIPLATFORM =
...
FlashCoinGUI::FlashCoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &FlashCoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &FlashCoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &FlashCoinGUI::showModalOverlay);
...
void FlashCoinGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &FlashCoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &FlashCoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &FlashCoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed FlashCoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed FlashCoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a flashcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible FlashCoin command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &FlashCoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &FlashCoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &FlashCoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &FlashCoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &FlashCoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &FlashCoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &FlashCoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &FlashCoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &FlashCoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &FlashCoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &FlashCoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &FlashCoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &FlashCoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &FlashCoinGUI::showDebugWindow);
}

void FlashCoinGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void FlashCoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &FlashCoinGUI::setCurrentWalletBySelectorIndex);
...
void FlashCoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &FlashCoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &FlashCoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &FlashCoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &FlashCoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void FlashCoinGUI::enableHistoryAction(bool privacy)
{
...
void FlashCoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &FlashCoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &FlashCoinGUI::removeWallet);
...
WalletController* FlashCoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void FlashCoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &FlashCoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &FlashCoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &FlashCoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &FlashCoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &FlashCoinGUI::incomingTransaction);
    connect(this, &FlashCoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void FlashCoinGUI::removeWallet(WalletModel* walletModel)
{
...
void FlashCoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void FlashCoinGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void FlashCoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void FlashCoinGUI::setWalletActionsEnabled(bool enabled)
{
...
void FlashCoinGUI::createTrayIcon()
{
...
void FlashCoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &FlashCoinGUI::toggleHidden);
...
void FlashCoinGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void FlashCoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void FlashCoinGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void FlashCoinGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void FlashCoinGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void FlashCoinGUI::openClicked()
{
...
void FlashCoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void FlashCoinGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void FlashCoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void FlashCoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void FlashCoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void FlashCoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void FlashCoinGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void FlashCoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to FlashCoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void FlashCoinGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void FlashCoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void FlashCoinGUI::updateHeadersSyncProgressLabel()
{
...
void FlashCoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void FlashCoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &FlashCoinGUI::quitRequested);
...
void FlashCoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void FlashCoinGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &FlashCoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void FlashCoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void FlashCoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &FlashCoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &FlashCoinGUI::show);
                e->ignore();
            }
        }
    }
...
void FlashCoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void FlashCoinGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void FlashCoinGUI::incomingTransaction(const QString& date, FlashCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(FlashCoinUnits::formatWithUnit(unit, amount, true));
...
void FlashCoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void FlashCoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool FlashCoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool FlashCoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void FlashCoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void FlashCoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void FlashCoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void FlashCoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void FlashCoinGUI::updateWindowTitle()
{
...
void FlashCoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void FlashCoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void FlashCoinGUI::detectShutdown()
{
...
void FlashCoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void FlashCoinGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(FlashCoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = FlashCoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void FlashCoinGUI::subscribeToCoreSignals()
{
...
void FlashCoinGUI::unsubscribeFromCoreSignals()
{
...
bool FlashCoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<FlashCoinUnit> units = FlashCoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const FlashCoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, FlashCoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const FlashCoinUnit u : FlashCoinUnits::availableUnits()) {
        menu->addAction(FlashCoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(FlashCoinUnit newUnits)
{
    setText(FlashCoinUnits::longName(newUnits));
}
