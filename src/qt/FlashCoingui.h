...
#ifndef FlashCoin_QT_FlashCoinGUI_H
#define FlashCoin_QT_FlashCoinGUI_H
...
/**
  FlashCoin GUI main class. This class represents the main window of the FlashCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FlashCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FlashCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~FlashCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a FlashCoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, FlashCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed FlashCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(FlashCoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // FlashCoin_QT_FlashCoinGUI_H
