...
#ifndef FlashCoin_QT_SENDCOINSENTRY_H
#define FlashCoin_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending FlashCoins.
 */
...
#endif // FlashCoin_QT_SENDCOINSENTRY_H
