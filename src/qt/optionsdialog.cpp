      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->FlashCoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->FlashCoinAtStartup);
    ...
    ui->FlashCoinAtStartup->setToolTip(ui->FlashCoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->FlashCoinAtStartup->setText(ui->FlashCoinAtStartup->text().arg(CLIENT_NAME));

    ui->openFlashCoinConfButton->setToolTip(ui->openFlashCoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new FlashCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->FlashCoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFlashCoinConfButton_clicked()
{
