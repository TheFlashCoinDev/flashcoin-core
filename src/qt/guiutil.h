...
#ifndef FlashCoin_QT_GUIUTIL_H
#define FlashCoin_QT_GUIUTIL_H
...
/** Utility functions used by the FlashCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "FlashCoin:" URI into recipient object, return true on successful parsing
