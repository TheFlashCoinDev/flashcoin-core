...
#ifndef FlashCoin_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define FlashCoin_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // FlashCoin_PRIMITIVES_TRANSACTION_IDENTIFIER_H
