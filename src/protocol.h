...
// Copyright (c) 2009-2022 The FlashCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FlashCoin_PROTOCOL_H
#define FlashCoin_PROTOCOL_H
...
/**
 * FlashCoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all FlashCoin non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // FlashCoin-development mailing list. Remember that service bits are just
