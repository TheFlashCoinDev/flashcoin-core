...
#ifndef FlashCoin_TXGRAPH_H
#define FlashCoin_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingFlashCoin.org/t/introduction-to-cluster-linearization/1032
 *
