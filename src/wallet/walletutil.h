// Copyright (c) 2017-2021 The FlashCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FlashCoin_WALLET_WALLETUTIL_H
#define FlashCoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! FlashCoin from opening the wallet, thinking it was newly created, and
...
#endif // FlashCoin_WALLET_WALLETUTIL_H
