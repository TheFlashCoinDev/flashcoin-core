...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{
        ...
        "Returns a new FlashCoin address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new FlashCoin address"
                },
                RPCExamples{
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The FlashCoin address to be associated with a label."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The FlashCoin address"},
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{
        ...
        "Return information about the given FlashCoin address.\n"
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The FlashCoin address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The FlashCoin address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "FlashCoin address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
