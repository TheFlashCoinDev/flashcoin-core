...
#ifndef FlashCoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define FlashCoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // FlashCoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
