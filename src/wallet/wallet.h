...
#ifndef FlashCoin_WALLET_WALLET_H
#define FlashCoin_WALLET_WALLET_H
...
public:
     ...
     * FlashCoin-wallet tool code or by wallet migration code. If this is called
...
#endif // FlashCoin_WALLET_WALLET_H
