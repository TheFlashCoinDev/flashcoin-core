...
#ifndef FlashCoin_NODE_CONNECTION_TYPES_H
#define FlashCoin_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/FlashCoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on FlashCoin’s Peer-to-Peer Network")
...
#endif // FlashCoin_NODE_CONNECTION_TYPES_H
