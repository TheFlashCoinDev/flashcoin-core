...
#ifndef FlashCoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define FlashCoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // FlashCoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
