// Copyright (c) 2019-2020 The FlashCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FlashCoin_TEST_UTIL_TRANSACTION_UTILS_H
#define FlashCoin_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // FlashCoin_TEST_UTIL_TRANSACTION_UTILS_H
