...
#ifndef FlashCoin_TEST_UTIL_SETUP_COMMON_H
#define FlashCoin_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/FlashCoin/FlashCoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // FlashCoin_TEST_UTIL_SETUP_COMMON_H
