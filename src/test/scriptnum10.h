...
#ifndef FlashCoin_TEST_SCRIPTNUM10_H
#define FlashCoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from FlashCoin 0.10.0, for cross-comparison.
 */
public:
...
#endif // FlashCoin_TEST_SCRIPTNUM10_H
