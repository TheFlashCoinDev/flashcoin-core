// Copyright (c) 2012-2022 The FlashCoin developers
...
{
    BOOST_CHECK(TestSplitHost("www.FlashCoincore.org", "www.FlashCoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.FlashCoincore.org]", "www.FlashCoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.FlashCoincore.org:80", "www.FlashCoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.FlashCoincore.org]:80", "www.FlashCoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.FlashCoincore.org:65536", "www.FlashCoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.FlashCoincore.org:0", "www.FlashCoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.FlashCoincore.org:", "www.FlashCoincore.org:", 0, false));
}
