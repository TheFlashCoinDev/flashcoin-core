...
#ifndef FlashCoin_ADDRMAN_IMPL_H
#define FlashCoin_ADDRMAN_IMPL_H
 ...
 * see https://FlashCoincore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // FlashCoin_ADDRMAN_IMPL_H
