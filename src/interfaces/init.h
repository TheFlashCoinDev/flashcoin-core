...
#ifndef FlashCoin_INTERFACES_INIT_H
#define FlashCoin_INTERFACES_INIT_H
...
//! (FlashCoin-gui, FlashCoin-node, FlashCoin-wallet, FlashCoind, FlashCoin-qt) and each
...
#endif // FlashCoin_INTERFACES_INIT_H
