...
#ifndef FlashCoin_INTERFACES_NODE_H
#define FlashCoin_INTERFACES_NODE_H
...
//! Top-level interface for a FlashCoin node (FlashCoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or FlashCoin.conf.
...
#endif // FlashCoin_INTERFACES_NODE_H
