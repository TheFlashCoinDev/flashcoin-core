...
#ifndef FlashCoin_IPC_CAPNP_COMMON_TYPES_H
#define FlashCoin_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between FlashCoin processes.
...
//! Functions to serialize / deserialize common FlashCoin types.
namespace mp {
...
#endif // FlashCoin_IPC_CAPNP_COMMON_TYPES_H
