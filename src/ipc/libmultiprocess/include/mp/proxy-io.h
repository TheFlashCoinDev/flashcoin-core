...
extern thread_local ThreadContext g_thread_context; // NOLINT(FlashCoin-nontrivial-threadlocal)
// Silence nonstandard FlashCoin tidy error "Variable with non-trivial destructor
