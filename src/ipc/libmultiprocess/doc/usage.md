...
- An **API definition** declaring how the interface is called. Included examples: [calculator.h](https://github.com/FlashCoin-core/libmultiprocess/blob/master/example/calculator.h), [printer.h](https://github.com/FlashCoin-core/libmultiprocess/blob/master/example/printer.h), [init.h](https://github.com/FlashCoin-core/libmultiprocess/blob/master/example/init.h). FlashCoin examples: [node.h](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/interfaces/node.h), [wallet.h](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/interfaces/wallet.h), [echo.h](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/interfaces/echo.h), [init.h](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/interfaces/init.h).

- A **data definition** declaring how interface calls get sent across the wire. Included examples: [calculator.capnp](https://github.com/FlashCoin-core/libmultiprocess/blob/master/example/calculator.capnp), [printer.capnp](https://github.com/FlashCoin-core/libmultiprocess/blob/master/example/printer.capnp), [init.capnp](https://github.com/FlashCoin-core/libmultiprocess/blob/master/example/init.capnp). FlashCoin examples: [node.capnp](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/ipc/capnp/node.capnp), [wallet.capnp](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/ipc/capnp/wallet.capnp), [echo.capnp](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/ipc/capnp/echo.capnp), [init.capnp](https://github.com/ryanofsky/FlashCoin/blob/ipc-export/src/ipc/capnp/init.capnp).
