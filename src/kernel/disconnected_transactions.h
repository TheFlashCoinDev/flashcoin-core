...
#ifndef FlashCoin_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define FlashCoin_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // FlashCoin_KERNEL_DISCONNECTED_TRANSACTIONS_H
