...
// Copyright (c) 2009-2021 The FlashCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FlashCoin_RPC_PROTOCOL_H
#define FlashCoin_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in FlashCoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< FlashCoin is not connected
...
#endif // FlashCoin_RPC_PROTOCOL_H
