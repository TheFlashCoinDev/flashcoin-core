...
// The <FlashCoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/FlashCoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure FlashCoin copyright is not removed by accident
    if (copyright_devs.find("FlashCoin") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The FlashCoin developers";
    }
