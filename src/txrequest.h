...
#ifndef FlashCoin_TXREQUEST_H
#define FlashCoin_TXREQUEST_H
 ...
 *   specific transaction. See https://FlashCoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
