// Copyright (c) 2018-2019 The FlashCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FlashCoin_UTIL_THREADNAMES_H
#define FlashCoin_UTIL_THREADNAMES_H
...
#endif // FlashCoin_UTIL_THREADNAMES_H
