...
#ifndef FlashCoin_COMMON_ARGS_H
#define FlashCoin_COMMON_ARGS_H
...
extern const char * const FlashCoin_CONF_FILENAME;
extern const char * const FlashCoin_SETTINGS_FILENAME;
