...
#ifndef FlashCoin_COMMON_SIGNMESSAGE_H
#define FlashCoin_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's FlashCoin address, it must refer to a public key.
...
#endif // FlashCoin_COMMON_SIGNMESSAGE_H
