...
function(extract_strings output)
  ...
  file(STRINGS "FlashCoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *FlashCoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"FlashCoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/FlashCoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/FlashCoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/FlashCoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/FlashCoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/FlashCoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/FlashCoin_en.xlf" FlashCoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" FlashCoin_en "${FlashCoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" FlashCoin_en "${FlashCoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/FlashCoin_en.xlf" "${FlashCoin_en}")
