...
Verify that a FlashCoind node can use an external signer command.
...
class RPCSignerTest(FlashCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart FlashCoind with -signer=<cmd>',
