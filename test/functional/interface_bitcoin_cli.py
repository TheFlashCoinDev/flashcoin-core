#!/usr/bin/env python3
# Copyright (c) 2017-2022 The FlashCoin developers
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"FlashCoin-cli -h\" for help or \"FlashCoin-cli listwallets\" to see "
...
class TestFlashCoinCli(FlashCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `FlashCoin-cli getblockchaininfo`")
        ...
        # Prevent FlashCoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and FlashCoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and FlashCoin-cli getwalletinfo return expected wallet info")
            ...
            # Test FlashCoin-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestFlashCoinCli(__file__).main()
