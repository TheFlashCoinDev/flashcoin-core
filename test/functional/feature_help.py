#!/usr/bin/env python3
# Copyright (c) 2018-2021 The FlashCoin developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting FlashCoin with -h works as expected."""

from test_framework.test_framework import FlashCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(FlashCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start FlashCoin with -h for help text")
        ...
        self.log.info("Start FlashCoin with -version for version information")
        ...
        self.log.info("Start FlashCoind with -fakearg to make sure it does not start")
