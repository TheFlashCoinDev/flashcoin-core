...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The FlashCoind node closes feeler connections as soon as a version
...
class P2PAddConnections(FlashCoinTestFramework):
    ...
    def run_test(self):
        ...
        # FlashCoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that FlashCoind sends its own version prior to processing
