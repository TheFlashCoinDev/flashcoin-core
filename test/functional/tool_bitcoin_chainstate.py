...
class FlashCoinChainstateTest(FlashCoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_FlashCoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing FlashCoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    FlashCoinChainstateTest(__file__).main()
