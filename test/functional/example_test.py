...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FlashCoinTestFramework
    pass


class ExampleTest(FlashCoinTestFramework):
    # Each functional test is a subclass of the FlashCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        FlashCoinTestFramework class so other tests can use it."""
