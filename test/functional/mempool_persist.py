...
By default, FlashCoind will dump mempool on shutdown and
...
class MempoolPersistTest(FlashCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent FlashCoind from writing mempool.dat to disk. Verify that `savemempool` fails")
