...
class TestShell:
    """Wrapper Class for FlashCoinTestFramework.

    The TestShell class extends the FlashCoinTestFramework
    ...
    class __TestShell(FlashCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by FlashCoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # FlashCoinTestFramework instances are supposed to be constructed with the path
