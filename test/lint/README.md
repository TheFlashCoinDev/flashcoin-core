...
```sh
DOCKER_BUILDKIT=1 docker build -t FlashCoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/FlashCoin -it FlashCoin-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/FlashCoin-core/crc32c-subtree.git (branch FlashCoin-fork)
* for `src/crypto/ctaes`: https://github.com/FlashCoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/FlashCoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/FlashCoin-core/leveldb-subtree.git (branch FlashCoin-fork)
* for `src/minisketch`: https://github.com/FlashCoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/FlashCoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/FlashCoin-core/secp256k1.git
```
