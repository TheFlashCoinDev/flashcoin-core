UNIX BUILD NOTES
====================
Some notes on how to build FlashCoin in Unix.
...
memory available when compiling FlashCoin. On systems with less, gcc can be
...
To build FlashCoin without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, FlashCoin can
...
This example lists the steps necessary to setup and build a command line only distribution of the latest changes on Arch Linux:
    ...
    ./build/bin/FlashCoind
    ./build/bin/FlashCoin help
