...
```sh
cmake --build build --target FlashCoind FlashCoin-cli
cmake --build build --target FlashCoin-qt
cmake --build build --target bench_FlashCoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:FlashCoin/FlashCoin.git
```
...
> e.g. github.com/FlashCoin/FlashCoin.git or for the GUI github.com/FlashCoin-core/gui
