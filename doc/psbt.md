# PSBT Howto for FlashCoin

Since FlashCoin 0.17, an RPC interface exists for Partially Signed FlashCoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/FlashCoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for FlashCoin transactions that are not fully signed
...
#### Multisig with multiple FlashCoin instances
