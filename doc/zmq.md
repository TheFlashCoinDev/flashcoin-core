...
The FlashCoin daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in FlashCoin requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ FlashCoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/FlashCoind.tx.raw \
