FlashCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/FlashCoin/files/FlashCoin/FlashCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the FlashCoin
...
New/changed settings (command-line or FlashCoin.conf file)
--------------------------------------------------------
