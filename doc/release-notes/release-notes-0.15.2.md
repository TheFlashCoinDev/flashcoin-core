FlashCoin version *0.15.2* is now available from:

  <https://FlashCoincore.org/bin/FlashCoin-core-0.15.2/>
...
FlashCoin versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in FlashCoin-tx (TheBlueMatt)
