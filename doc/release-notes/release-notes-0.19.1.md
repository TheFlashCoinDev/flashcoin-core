...
FlashCoin version 0.19.1 is now available from:

  <https://FlashCoincore.org/bin/FlashCoin-core-0.19.1/>
...
From FlashCoin 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as FlashCoin is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, FlashCoin does not yet change appearance when
...
- #17488 fix "FlashCoind already running" warnings on macOS (fanquake)
