FlashCoin version 0.13.2 is now available from:

  <https://FlashCoin.org/bin/FlashCoin-core-0.13.2/>
...
- #8908 `4a974b2` Update FlashCoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow FlashCoin-tx to create v2 transactions (btcdrak)
