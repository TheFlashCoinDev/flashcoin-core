FlashCoin version *0.14.3* is now available from:

  <https://FlashCoin.org/bin/FlashCoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/FlashCoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
