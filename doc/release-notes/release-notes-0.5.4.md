FlashCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/FlashCoin/files/FlashCoin/FlashCoin-0.5.4/
...
http://gitorious.org/FlashCoin/FlashCoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix FlashCoin-Qt notifications under Growl 1.3.
Increase required age of FlashCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFlashCoin properly when installing FlashCoin-Qt over it. (Windows)
