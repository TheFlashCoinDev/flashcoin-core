FlashCoin version 0.9.4 is now available from:

  https://FlashCoin.org/bin/0.9.4/
...
this update is incompatible with the FlashCoin system and could lead to consensus
forks.

FlashCoin released binaries from https://FlashCoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~FlashCoin/+archive/ubuntu/FlashCoin
- A third-party or self-compiled FlashCoin

upgrade to FlashCoin 0.9.4, which includes a workaround, **before** updating
OpenSSL.
