FlashCoin version 0.9.1 is now available from:

  https://FlashCoin.org/bin/0.9.1/
...
FlashCoind from any pre-0.9.1 version, and have enabled SSL for RPC and
