FlashCoin version 0.16.1 is now available from:

  <https://FlashCoincore.org/bin/FlashCoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting FlashCoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure FlashCoind processes are cleaned up when tests end (sdaftuar)
