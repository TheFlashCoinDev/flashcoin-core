FlashCoin version 27.0 is now available from:

  <https://FlashCoincore.org/bin/FlashCoin-core-27.0/>
...
libFlashCoinconsensus
-------------------

- libFlashCoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libFlashCoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build FlashCoin. (#28349)
...
- Various fixes to prevent issues where subsequent instances of FlashCoin would
