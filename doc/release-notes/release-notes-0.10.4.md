FlashCoin version 0.10.4 is now available from:

  <https://FlashCoin.org/bin/FlashCoin-core-0.10.4/>
...
- #6953 `43c2789` Split FlashCoin-tx into its own package
- #6953 `dfe0d4d` Include FlashCoin-tx binary on Debian/Ubuntu
