...
FlashCoin version 0.21.1 is now available from:

  <https://FlashCoincore.org/bin/FlashCoin-core-0.21.1/>
...
fungibility of all FlashCoins. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to FlashCoin's wallet is
...
FAQ](https://FlashCoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/FlashCoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/FlashCoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/FlashCoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit FlashCoin](https://FlashCoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-FlashCoin)
  - [What do Schnorr Signatures Mean for FlashCoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-FlashCoin)
...
- Development history overview
  - [Taproot](https://FlashCoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://FlashCoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://FlashCoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://FlashCoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://FlashCoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/FlashCoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/FlashCoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to FlashCoin.conf documentation (jonatack)
