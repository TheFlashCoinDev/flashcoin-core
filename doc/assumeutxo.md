...
Assumeutxo is a feature that allows fast bootstrapping of a validating FlashCoind
instance.
...
```
$ FlashCoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ FlashCoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
